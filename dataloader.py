...
def load_data(config):
    ...
    if config['dataset_name'] in ['cifar10']:
        ...
        os.makedirs("../input/mybishe/Dataset/Dataset", exist_ok=True)
        # dataset = CIFAR10('./Dataset/CIFAR10/train', train=True, download=True, transform=img_transform)
        dataset = CIFAR10('../input/mybishe/Dataset/Dataset/CIFAR10/train', train=True, download=True, transform=img_transform)
        ...
        os.makedirs("../input/mybishe/Dataset/Dataset/CIFAR10/test", exist_ok=True)
        # test_set = CIFAR10("./Dataset/CIFAR10/test", train=False, download=True, transform=img_transform)
        test_set = CIFAR10("../input/mybishe/Dataset/Dataset/CIFAR10/test", train=False, download=True, transform=img_transform)
        ...
        print("MVtec DataLoader Called...")

        os.makedirs(test_data_path, exist_ok=True)
        test_set = ImageFolder(root=test_data_path, transform=orig_transform)
    
    elif config['dataset_name'] in ['mydata']:
        data_path = "Dataset/mydata/{}/train".format(config['mydata_name'])
        test_data_path = "Dataset/mydata/{}/test".format(config['mydata_name'])
        ...
        os.makedirs(data_path, exist_ok=True)
        dataset = ImageFolder(root=data_path, transform=orig_transform)
        print("mydata DataLoader Called...")

        os.makedirs(test_data_path, exist_ok=True)
        test_set = ImageFolder(root=test_data_path, transform=orig_transform)

    elif config['dataset_name'] in ['data_xjw']:
        data_path = "Dataset/data_xjw/{}/train".format(config['mydata_name'])
        test_data_path = "Dataset/data_xjw/{}/test".format(config['mydata_name'])
...
def load_localization_data(config):
    ...
    ground_data_path = "Dataset/mydata/{}/ground_truth".format(config['mydata_name'])
    ...
    return train_dataloader, test_dataloader, x_ground
